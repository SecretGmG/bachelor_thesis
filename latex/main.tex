...
\subsection{Threshold subtraction of multiple E-surfaces}
When starting to consider multiple E-surfaces we can simply add the counterterms for each E-surface separately.

Let us consider two intersecting E-surfaces $\ELIPT{i}{j}$ and $\ELIPT{i}{k}$ with counterterms $I_{\on{CT}}^{\ELIPT{i}{j}}$ and $I_{\on{CT}}^{\ELIPT{i}{k}}$. We can see that the factor $f(k^*)$ in the counterterms of each E-surface diverge, as we approach the intersection of the E-surfaces. 
