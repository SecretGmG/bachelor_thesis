...
\begin{align*}
    I(q,p,m_\psi)
     & = \int \frac{\dd[3]{k}}{{(4\pi)}^3} \frac{1}{E_12E_2E_3} \Bigg[ \\
...
\section{OneLOopBridge}\label{sec:oneloopbridge}
...
repository and compile it manually. Then run maturin to install the bindings
